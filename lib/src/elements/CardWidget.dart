              ...
              Row(
                children: <Widget>[
                  ...
                  Container(
                    ...
                    padding: EdgeInsets.symmetric(horizontal: 12, vertical: 3),
                    decoration: BoxDecoration(color: restaurant.availableForDelivery ? Colors.green : Colors.orange, borderRadius: BorderRadius.circular(24)),
                    child: restaurant.availableForDelivery
                        ? Text(
